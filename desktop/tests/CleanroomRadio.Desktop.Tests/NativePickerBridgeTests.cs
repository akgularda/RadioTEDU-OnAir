...
public class NativePickerBridgeTests
{
    ...
    {
        var panel = new Uri("http://127.0.0.1:8100/static/deterministic-wall/index.html");

        Assert.True(NativePickerBridge.IsTrustedSource(
            panel,
            "http://127.0.0.1:8100/static/deterministic-wall/index.html#media"));
        Assert.False(NativePickerBridge.IsTrustedSource(
            panel,
            "https://example.org/static/deterministic-wall/index.html"));
