...
{
    public const string RequestType = "radiotedu-picker-request";
    public const string ResponseType = "radiotedu-picker-response";
        ...
        try
        {
            ...
            if (description.Length == 0)
            {
                description = kind == "folder"
                    ? "Select a RadioTEDU folder"
                    : "Select a RadioTEDU file";
            }
