...
(function () {
    ...
    function renderConfig(state) {
        ...
        populateSelect(document.getElementById('setupStreamCodec'), state?.codec_presets || [], config.stream_codec_profile || 'aac_plus_196');
    ...
    function readConfigPayload() {
        return {
            ...
            stream_codec_profile: fieldValue('setupStreamCodec') || 'aac_plus_196',
